...
<div class="panel panel-info">
    ...
    <div class="panel-body">
		...
		<div class="form-group">
            {!! Form::label('product_category_name',trans('product::product.product_category_name_label')) !!}
            {!! Form::text('product_category_name', @$params['product_category_name'], ['class' => 'form-control', 'placeholder' => trans('product::product.product_category_name')]) !!}
        </div>
