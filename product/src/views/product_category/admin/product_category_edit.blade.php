            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin">
                        {!! !empty($product->product_category_id) ? '<i class="fa fa-pencil"></i>'.trans('product::product.form_edit') : '<i class="fa fa-users"></i>'.trans('product::product.form_add') !!}
                    </h3>
                </div>
                <!-- ERRORS NAME  -->
