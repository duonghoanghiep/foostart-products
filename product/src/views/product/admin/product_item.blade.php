...
<table class="table table-hover">
    <thead>
        <tr>
            ...
            <th style='width:20%'>Product Money</th>
            <th style='width:30%'>Product Date Import</th>
            <th style='width:30%'>Product Date Export</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{!! $product->product_date_import !!}</td>
            <td>{!! $product->product_date_export !!}</td>
